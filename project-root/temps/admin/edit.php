...
<head>
  <meta charset="UTF-8">
  <title>Редактировать поста</title>
...
<body>
  ...
  <main>
    <div class="content">
      <h1 class="">Редактировать пост</h1>
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="input-field">
          ...
          <div class="form-input">
            ...
            <textarea type="text" name="description" class="form-control" value="<?= htmlspecialchars($post['description']) ?>" required></textarea>
          </div>
        </div>
